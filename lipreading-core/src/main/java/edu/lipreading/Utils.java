...
public class Utils {
    ...
    public static String getFileNameFromPath(String pathToLoad) throws UnsupportedEncodingException {
        String[] split = pathToLoad.split("\\");//("/");
        String fileName = split[split.length - 1];
        return fileName; //URLDecoder.decode(fileName, "ISO-8859-1");
    }
